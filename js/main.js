...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/box_office", { templateUrl: "partials/admin/event_information.html", controller: "HomeCtrl" })
    .when("/service", { templateUrl: "partials/admin/event_information.html", controller: "HomeCtrl" })
    .when("/allyhub", { templateUrl: "partials/admin/event_information.html", controller: "HomeCtrl" })
